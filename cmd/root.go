...
var rootCmd = &cobra.Command{
	Use:   "fkit",
	Short: "Finding Toolkit.",
	Long: `Use the finding toolkit to work with findings in a standard format.
`,
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fkit.yaml)")
